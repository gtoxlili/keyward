...
The protocol exists to make one promise: the Node never holds the key. **If you find any
...
- **In scope:** the protocol design and the spec; and, once they exist, the reference Client and
  Node SDK.
